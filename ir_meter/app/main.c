...
u8 com_add_cmd07[40] =
	...
	0x68, 0x11, 0x04, 0x33, 0x34, 0x33, 0x33, 0xae, 0x16 }; //正向有功总电能
/*
	{ 20, 0xfe, 0xfe, 0xfe, 0xfe,
	0x68, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa,
...
*/
	...
	{ 18, 0xfe, 0xfe, 0xfe, 0xfe,
	0x68, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa,
	0x68, 0x01, 0x02, 0x43, 0xc3, 0xd5, 0x16}; //正向有功总电能

u8 com_cmd07[18][25] = {

	{ 20, 0xfe, 0xfe, 0xfe, 0xfe,
	0x68, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa,
	0x68, 0x11, 0x04, 0x33, 0x34, 0x35, 0x35, 0xb2, 0x16 },    //A
	{ 20, 0xfe, 0xfe, 0xfe, 0xfe,
	0x68, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa, 0xaa,
...
u8 com_cmd97[18][40] = {
	...
	{ 18, 0xFE, 0xFE, 0xFE, 0xFE,
	0x68, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA,
	0x68, 0x01, 0x02, 0x54, 0xE9, 0x0C, 0x16 },
	{ 18, 0xFE, 0xFE, 0xFE, 0xFE,
	0x68, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA,
	0x68, 0x01, 0x02, 0x55, 0xE9, 0x0D, 0x16 },
	{ 18, 0xFE, 0xFE, 0xFE, 0xFE,
	0x68, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA,
	0x68, 0x01, 0x02, 0x56, 0xE9, 0x0E, 0x16 },
	...
	{ 18, 0xFE, 0xFE, 0xFE, 0xFE,
	0x68, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA,
	0x68, 0x01, 0x02, 0x45, 0xE9, 0xFD, 0x16 },
	{ 18, 0xFE, 0xFE, 0xFE, 0xFE,
	0x68, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA,
	0x68, 0x01, 0x02, 0x46, 0xE9, 0xFE, 0x16 },

	{ 18, 0xFE, 0xFE, 0xFE, 0xFE,
	0x68, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA,
	0x68, 0x01, 0x02, 0x83, 0xE9, 0x3B, 0x16 },
	{ 18, 0xFE, 0xFE, 0xFE, 0xFE,
	0x68, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA,
	0x68, 0x01, 0x02, 0x84, 0xE9, 0x3C, 0x16 },
	{ 18, 0xFE, 0xFE, 0xFE, 0xFE,
	0x68, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA,
	0x68, 0x01, 0x02, 0x85, 0xE9, 0x3D, 0x16 },
	{ 18, 0xFE, 0xFE, 0xFE, 0xFE,
	0x68, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA,
	0x68, 0x01, 0x02, 0x86, 0xE9, 0x3E, 0x16 },

	{ 18, 0xFE, 0xFE, 0xFE, 0xFE,
	0x68, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA,
	0x68, 0x01, 0x02, 0x63, 0xE9, 0x1B, 0x16 },
	{ 18, 0xFE, 0xFE, 0xFE, 0xFE,
	0x68, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA,
	0x68, 0x01, 0x02, 0x64, 0xE9, 0x1C, 0x16 },
	{ 18, 0xFE, 0xFE, 0xFE, 0xFE,
	0x68, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA,
	0x68, 0x01, 0x02, 0x65, 0xE9, 0x1D, 0x16 },
	{ 18, 0xFE, 0xFE, 0xFE, 0xFE,
	0x68, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA,
	0x68, 0x01, 0x02, 0x66, 0xE9, 0x1E, 0x16 },

	{ 18, 0xFE, 0xFE, 0xFE, 0xFE,
	0x68, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA,
	0x68, 0x01, 0x02, 0x73, 0xE9, 0x2B, 0x16 },
	{ 18, 0xFE, 0xFE, 0xFE, 0xFE,
	0x68, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA,
	0x68, 0x01, 0x02, 0x74, 0xE9, 0x2C, 0x16 },
	{ 18, 0xFE, 0xFE, 0xFE, 0xFE,
	0x68, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA,
	0x68, 0x01, 0x02, 0x75, 0xE9, 0x2D, 0x16 },
	{ 18, 0xFE, 0xFE, 0xFE, 0xFE,
	0x68, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA,
	0x68, 0x01, 0x02, 0x76, 0xE9, 0x2E, 0x16 }
};
...
//	LED_L();
	...
	while (1)
	{
		...
		( USB_TEST_READ() == 1)    //USB插上，进入设置状态，停止正常采集操作。
		{
			/******************************************************************/
			USB_EN();
		...
		else if (adc_en == 1)
		{
			...
			adc_value /= ADC_TIMES;
			adc2ascii_default(adc_value, adc_ascii);
